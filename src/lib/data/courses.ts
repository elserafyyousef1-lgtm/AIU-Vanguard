...
export const COURSES: Record<string, Course> = {
  ...
  AIE121: {
    ...
    subtitle: 'Metrics, regression, trees, SVM, KNN & clustering — 9 tutorials with worked examples',
    semester: 4,
    color: '#8b5cf6',
    ...
    hasAI: true,
    hasFormulas: false,
    tags: ['Metrics', 'Regression', 'Decision Trees', 'SVM', 'KNN', 'Clustering'],
  },
  MAT312: {
    slug: 'MAT312',
    code: 'MAT312',
...
export const SEMESTERS: Semester[] = [
  ...
  },
  {
    ...
    title: 'Semester 4',
    status: 'active',
    courses: ['CSE221', 'MAT312', 'AIE121', 'CSE311'],
